  ...
  export default {
    ...
    onReady: function () {
      ...
      this.wxRequest.get.call(this, this.wxUrl.checkLogin, {needToken: true}).then(res => {
        ...
        scanToPage.call(this,true,this.qrcodeUrl,this.waitSecond(beginT,new Date().getTime()))
      }, res => {
        console.log('splash screen token 身份失效')
        scanToPage.call(this,false,this.qrcodeUrl,this.waitSecond(beginT,new Date().getTime()))
      })
    },
