<template>
  <div class="person-info">
    ...
    <!--<template v-if="userInfo.mobile==='13822542317'">-->
      ...
      <!--&lt;!&ndash;<text class="title">线上审核版本号</text>&ndash;&gt;-->
      <!--&lt;!&ndash;<text class="content">{{onlineReviewVersion}}</text>&ndash;&gt;-->
      <!--&lt;!&ndash;<image class="arrow" src="/static/images/menu-arrow.png"></image>&ndash;&gt;-->
      <!--&lt;!&ndash;</div>&ndash;&gt;-->

      <!--&lt;!&ndash;<div class="line-1-px"></div>&ndash;&gt;-->
    <!--</template>-->
